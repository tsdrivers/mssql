...
Deno.test("utf8Column - custom collation", () => {
  ...
  assertEquals(
    result,
    "[Slug] varchar(100) COLLATE LATIN1_GENERAL_100_BIN2_UTF8",
  );
});
...
Deno.test("utf8Column - case-sensitive collation", () => {
  ...
  assertEquals(
    result,
    "[Code] varchar(50) COLLATE LATIN1_GENERAL_100_CS_AS_SC_UTF8",
  );
});
